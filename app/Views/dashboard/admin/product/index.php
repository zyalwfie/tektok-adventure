                            ...
                            <?php foreach ($paginatedProducts as $product) : ?>
                                <tr>
                                    ...
                                    <td class="px-0 text-dark fw-medium text-end">
                                        ...
                                        <button type="button" class="badge bg-danger btn" data-bs-toggle="modal" data-bs-target="#confirmModal">Hapus</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?= form_open(route_to('admin.products.destroy', $product['product_slug'])) ?>
